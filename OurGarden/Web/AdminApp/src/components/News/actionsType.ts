...
export interface IAddOrUpdateNewsRequest {
  type: typeof ADD_OR_UPDATE_NEWS_REQUEST;
}
export interface IAddOrUpdateNewsSuccess {
  type: typeof ADD_OR_UPDATE_NEWS_SUCCESS;
  payload: boolean;
}
export interface IAddOrUpdateNewsError {
  type: typeof ADD_OR_UPDATE_NEWS_ERROR;
  errorMessage: string;
}
export type TAddOrUpdateNews =
  | IAddOrUpdateNewsRequest
  | IAddOrUpdateNewsSuccess
  | IAddOrUpdateNewsError;

export interface IDeleteNewsRequest {
  type: typeof DELETE_NEWS_REQUEST;
}
export interface IDeleteNewsSuccess {
  type: typeof DELETE_NEWS_SUCCESS;
  payload: boolean;
}
export interface IDeleteNewsError {
