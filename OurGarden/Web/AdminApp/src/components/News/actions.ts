...
export const actionCreators = {
  ...
  addOrUpdateNews: (data: INewsDTO): IAppThunkAction<t.TAddOrUpdateNews | t.TGetNewsList | t.ICleanErrorInnerAction> => (dispatch, getState) => {
  ...
  removeNews: (newsId: string | number): IAppThunkAction<t.IDeleteNews | t.TGetNewsList | t.ICleanErrorInnerAction> => (dispatch, getState) => {
    const apiUrl = "Delete";
    const xptToHeader = GetXsrfToHeader(getState);
