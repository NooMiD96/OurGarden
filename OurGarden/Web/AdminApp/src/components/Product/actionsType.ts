...
export type TAddOrUpdateProduct = IAddOrUpdateProductRequest | IAddOrUpdateProductSuccess | IAddOrUpdateProductError;

export interface IDeleteProductRequest { type: typeof DELETE_PRODUCT_REQUEST }
export interface IDeleteProductSuccess { type: typeof DELETE_PRODUCT_SUCCESS; payload: boolean }
export interface IDeleteProductError { type: typeof DELETE_PRODUCT_ERROR; errorMessage: string }
export type IDeleteProduct = IDeleteProductRequest | IDeleteProductSuccess | IDeleteProductError;
